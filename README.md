...
- Flasheo directo mediante **ESP Web Tools** (compatible con Chrome y Edge).  
- Diseño **CyberTech Dark Pro** con efecto neón.  
- Compatible con múltiples firmwares (pronto mas firmwares).  
- 100% alojado en GitHub Pages.
